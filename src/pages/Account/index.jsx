...
export default function Account() {
  ...
  async function handleUpload() {
    ...
    uploadBytes(uploadRef, imgAvatar).then((snapshot) => {
    ...
    <main className="container-account">
      <div data-aos="zoom-out" className="board">
        ...
        <button className="btn-default" onClick={logOut}>
          Sair da conta <FaArrowRightFromBracket />
        </button>
      </div>
          ...
          <form onSubmit={handleEdit}>
            ...
            <div className="avatar-account">
              <label>
                ...
                {avatarUrl === null ? (
                  <img
                    src={require("../../assets/imgs/avater-default.jpg")}
                    alt="Foto de perfil"
                  />
                ) : (

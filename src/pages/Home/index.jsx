      ...
      <div className="boxes-home">
        <div className="box-home">
          ...
          <div className="home-text">
            ...
            <p>
              Registrar despesas permite acompanhar para onde o dinheiro está
              indo. Isso ajuda a identificar gastos desnecessários e possibilita
              ajustes para manter as finanças em ordem.
            </p>
        ...
        <div className="box-home">
          <div className="home-text">
            ...
            <p>
              ...
              da situação financeira. Isso ajuda a entender o patrimônio
              líquido, identificar tendências de crescimento ou declínio e tomar
              decisões informadas.
            </p>
            {/* <Link className='btn-default' to='/register'><MdOutlineAttachMoney /> Faça parte!</Link> */}
          </div>
        ...
        <div className="box-home">
          ...
          <div className="home-text">
            ...
            <p>
              ...
              alinhado com os objetivos financeiros. Isso auxilia na
              distribuição adequada dos recursos e evita gastos excessivos.
            </p>
            {/* <Link className='btn-default' to='/register'><MdOutlineAttachMoney /> Faça parte!</Link> */}
          </div>
        </div>

...
export default function Performance() {
  ...
  useEffect(() => {
    ...
    const datas = parseTransactionLs.filter(
      (e) => Number(e.date.split("-")[1]) === monthCurrent
    );

    // expenses
    const expenses = datas.filter((e) => e.value < 0);
    ...
    // revenues
    const revenues = datas.filter((e) => e.value > 0);
    ...
    <div className="container-performance">
      ...
      <div className="transaction-balance">
        ...
        <dir data-aos="fade-right" className="balance-text">
          ...
          <p>
            Descubra o Balanço Mensal e conquiste um domínio preciso das suas
            finanças, com insights valiosos para manter tudo em ordem.
          </p>
          <p>
            Estabeleça o hábito de monitorar suas transações regularmente e crie
            um orçamento realista para garantir que suas contas estejam sempre
            em dia.
          </p>
        </dir>
      </div>

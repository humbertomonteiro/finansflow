...
export default function Transaction({ searchRef, data, setState, setData, setDelete, setSolve, setEdit }) {
        ...
        <div key={data.id} className='transaction'>
            {
                ...
                <>
                    <div>
                        <div className={data.value > 0 ?
                            'category revenue' : 'category expensive' }>
                            {
                                categories.map(a => a.name === data.category && 
                                <div key={data.id}>
                                    {a.icon}
                                </div>)
                            }
            ...
            <div className='icon'
            onClick={() => handleSolveTransaction(data)}>
                {data.done ?

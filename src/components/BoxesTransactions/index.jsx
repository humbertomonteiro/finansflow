...
export default function BoxesTransactions() {
  ...
  useEffect(() => {
    function showTransactions() {
      ...
      formatValues(balance, setBalanceMonth);
      ...
      formatValues(revenuesValue, setRevenues);
      ...
      formatValues(expensesValue, setExpenses);
      ...
      formatValues(currentValues, setCurrentValue);
    }
    showTransactions();
  }, [monthSearch, yearSearch]);

  function formatValues(value, setState) {
    const balanceFormat = Number(value).toLocaleString("pt-BR");
    const balanceFixed = balanceFormat.includes(",")
      ? balanceFormat
      : `${balanceFormat},00`;

    setState(balanceFixed);
  }
  ...
  return (
    <div data-aos="fade-up" className="boxes-transactions">
      <Link to="/transactions/all" className="box-transactions">
        <div className="title">
          Saldo atual <BiSolidRightArrowCircle />
        </div>
        <div>
          <h2>
            <span>R$ </span>
      ...
      <Link to="/transactions/revenues" className="box-transactions">
        <div className="title">
          Receitas <BiSolidRightArrowCircle />
        </div>
        <div>
          <h2>
            <span>R$ </span>
      ...
      <Link to="/transactions/expenses" className="box-transactions">
        <div className="title">
          Despesas <BiSolidRightArrowCircle />
        </div>
        <div>
          <h2>
            <span>R$ </span>
      ...
      <Link to="/performance" className="box-transactions">
        <div className="title">
          Balanço mensal <BiSolidRightArrowCircle />
        </div>
        <div>
          <h2>
            <span>R$ </span>

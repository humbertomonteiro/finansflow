...
export default function BtnMonth() {
    ...
    const { setMonthSearch, monthSearch, setYearSearch, yearSearch } = useContext(UserContext)
    const date = new Date()
    ...
    return (
        <div className='btn-month'>
            <button onClick={handleBefore}><MdArrowBackIosNew /></button>
            <label>
            ...
            <h3>
                {
                    yearSearch === currentYear ? '' : yearSearch
                }
            </h3>
